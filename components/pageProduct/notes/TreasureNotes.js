...
import f1 from '../../../assets/images/treasure/f1.png';
import f2 from '../../../assets/images/treasure/f2.png';
import f3 from '../../../assets/images/treasure/f3.png';
import f4 from '../../../assets/images/treasure/f4.png';
import f5 from '../../../assets/images/treasure/f5.png';
import f6 from '../../../assets/images/treasure/f6.png';
import s from './Notes.module.scss';

export const TreasureNotes = () => {
      ...
      <div className={s.container}>
        ...
        <ul className={s.list}>
          <li onMouseEnter={handleVisibleF1} className={s.listItem}>
            ...
            <p className={s.descr}>
              Bergamot, citrus fusion, lavender, pink pepper, red fruit
            </p>
          ...
          <li
            ...
            <p className={s.descr}>
              Geranium, heliotrope, jasmine, sambac, rose, rhubarb
            </p>
            <div className={s.fotoRight}>
          ...
          <li
            ...
            <p className={s.descr}>
              Patchouli, vetiver, amber crystals, citrus
            </p>
            <div className={s.fotoRight}>
