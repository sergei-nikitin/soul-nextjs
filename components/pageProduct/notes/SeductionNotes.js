...
import f1 from '../../../assets/images/seduction/f1.png';
import f2 from '../../../assets/images/seduction/f2.png';
import f3 from '../../../assets/images/seduction/f3.png';
import f4 from '../../../assets/images/seduction/f4.png';
import f5 from '../../../assets/images/seduction/f5.png';
import f6 from '../../../assets/images/seduction/f6.png';
import s from './Notes.module.scss';

export const SeductionNotes = () => {
      ...
      <div className={s.container}>
        ...
        <ul className={s.list}>
          <li onMouseEnter={handleVisibleF1} className={s.listItem}>
            ...
            <p className={s.descr}>Davana, rum, geranium, coconut water</p>
          ...
          <li
            ...
            <p className={s.descr}>
              Osmanthus, orange blossom, jasmine, sambac, tuberose, neroli
            </p>
            <div className={s.fotoRight}>
          ...
          <li
            ...
            <p className={s.descr}>
              Sandalwood, vetiver, patchouli, amber, musks
            </p>
            <div className={s.fotoRight}>
